...
public class ResumoPacoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Drawable drawableDoPacote = RsourceUtil.devolveDrawable(this, pacoteSaoPaulo.getImagem());
        ...
        String moedaFormatada = MoedaUtil.formataParaBrasileiro(pacoteSaoPaulo.getPreco());
